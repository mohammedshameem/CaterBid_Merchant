...
import com.xminds.easyhomefix_merchant.fragment.TabListYourFixesFragment;
...
public class TrackYourFixFragmentTabHostActivity extends BaseActivity {
	...
	protected void onDestroy() {
		...
		//LocalBroadcastManager.getInstance(TrackYourFixFragmentTabHostActivity.this).unregisterReceiver(null);
		super.onDestroy();
	}
