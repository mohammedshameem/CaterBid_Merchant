...
public class TransactionHistoryFirstAdapter extends BaseAdapter {
	private Activity activity;
	private List<PaymentHolder> transactionList = new ArrayList<PaymentHolder>();
	private static LayoutInflater inflater=null;
	 
	public TransactionHistoryFirstAdapter(Activity activity,List<PaymentHolder> transactionList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			holder=new Holder();
			convertView=inflater.inflate(R.layout.transaction_history_list_layout, null);
			...
			holder.textViewimages= (ImageView)convertView.findViewById(R.id.textViewimages);
			...
			if(UtilValidate.isNotNull(transactionList.get(position))){
				...
				if(UtilValidate.isNotNull(transactionList.get(position).getPaymentType())){
					if(transactionList.get(position).getPaymentType().equalsIgnoreCase("paypal")){
						//holder.transactionType.setText("(Transfer)");
						...
						holder.transactionType.setVisibility(View.VISIBLE);
